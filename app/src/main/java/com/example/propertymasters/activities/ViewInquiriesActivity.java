...
public class ViewInquiriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ViewInquiriesActivity.this.finish();
            }
        });
    ...
    public void inquiryJsonRequest() {
...
//        }
        ...
        jsonObjectRequest = new JsonObjectRequest( URLs.URL_READ_INQUIRY, new Response.Listener<JSONObject>() {
